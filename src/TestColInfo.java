...
public class TestColInfo {
	public static void main(String[] args) {
        ...
        System.out.println("Taille de colonne : " + colInfo1.getLengthString());
        ...
        System.out.println("Taille de colonne : " + colInfo2.getLengthString());
        ...
        System.out.println("Taille de colonne : " + colInfo3.getLengthString());
